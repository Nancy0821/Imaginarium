    ...
    return (
        <div className="flex justify-center max-h-[calc(100vh-112px)] w-[65%] overflow-y-auto" >
            <Editor
                ...
                init={{
                    plugins: 'preview  importcss searchreplace autolink autosave save directionality visualblocks visualchars fullscreen image link media template codesample table charmap pagebreak nonbreaking anchor insertdatetime advlist lists wordcount help charmap quickbars casechange',
                    ...
                    content_style: 'body{ color: white; background: #222F3E; font-size: 18px; font-family:Helvetica,Arial,sans-serif;}',

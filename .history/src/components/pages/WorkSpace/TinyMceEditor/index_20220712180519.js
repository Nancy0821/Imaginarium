...
const TinyMceEditor = (props) => {
    ...
    const handleChange = () => {
        ...
        console.log("tinymce.activeEditor.editorCommands.commands.state: ", tinymce.activeEditor.editorCommands.commands.state.bold.isCommand);
    }
    useEffect(() => {
        ...
        <div className="flex justify-center max-h-[calc(100vh-112px)] w-[65%] overflow-y-auto" >
            <Editor
                ...
                init={{
                    ...
                    //         let styleArr = e.target.getAttribute("style");
                    //         // let val = styleArr.split(":")
                    //         console.log('Element clicked:', styleArr);

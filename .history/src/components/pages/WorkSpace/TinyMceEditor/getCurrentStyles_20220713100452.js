...
function getCurrentStyle(state, setState) {
    ...
    let unordered = tinymce.activeEditor.queryCommandValue('ApplyUnorderedListStyle');
    ...
    setState({ ...state, align: alignVal, lineH: lineHeight, bold: boldStatus, italic: italicStatus, underline: underlineStatus, strikethr: strikeStatus });

...
function getCurrentStyle(state, setState) {
    ...
    let isRtl = tinymce.activeEditor.queryCommandState("mceDirectionRTL");
    let isLtr = tinymce.activeEditor.queryCommandState("mceDirectionLTR");
    console.log("isRtl: ", isRtl);

    setState({ ...state, align: alignVal, lineH: lineHeight, Paragraph: isRtl });

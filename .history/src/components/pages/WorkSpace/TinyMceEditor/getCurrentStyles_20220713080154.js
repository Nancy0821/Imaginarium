...
function getCurrentStyle(state, setState) {
    ...
    let boldStatus = tinymce.activeEditor.queryCommandState("Italic");
    let boldStatus = tinymce.activeEditor.queryCommandState("Underline");
    let boldStatus = tinymce.activeEditor.queryCommandState("Strikethrough");

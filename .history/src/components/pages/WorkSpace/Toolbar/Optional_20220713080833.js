...
import { AlignCenterIcon, AlignJustifyIcon, AlignLeftIcon, AlignRightIcon, BoldIcon, ChevronRight, ConstBotIcon, ConstMidIcon, ConstTopIcon, DropDownIcon, FontCaseCapsIcon, FontCaseDefaultIcon, FontCaseHighSmallCapsIcon, FontCaseSmallCaps, FontCaseSmallIcon, FontDotLineIcon, FontOverlineIcon, FontStrikethroughIcon, FontUnderLineIcon, FontWrongLineIcon, IndentIcon, ItalicIcon, LetterSpacingIcon, LineHeightIcon, ListDiffIcon, ListIcon, ListNumIcon, ListRowIcon, ListSquareIcon, PHeightIcon, PlusIcon, RightIndentIcon, TimesIcon } from "../../../Svg";
    ...
    const handleListChange = (val) => {
        ...
        switch (val) {
            ...
            case 3:
                ...
                break;
            case 4:
                tinymce.activeEditor.execCommand('InsertUnorderedList', false, { 'list-style-type': 'circle' });
                break;
            case 5:
                tinymce.activeEditor.execCommand('InsertUnorderedList', false, { 'list-style-type': 'square' });
                break;
            case 6:
                tinymce.activeEditor.execCommand('InsertUnorderedList', false, { 'list-style-type': 'upper-alpha' });
                break;
            default:
                break;
        }
        ...
        <div>
            ...
            <div className=" flex flex-col items-start p-4 gap-3 border-b border-[#262626]">
                ...
                <div className="flex flex-row justify-between  items-center w-full ">
                    ...
                    <div className="flex flex-row justify-between items-center bg-[#161616] border border-[#404040] w-64 h-8 p-1 rounded-md">
                        <button
                            className={
                                "h-6 px-2 py-0.5 text-white text-[9px] leading-5 tracking-[.21em] rounded-[2px] flex items-center w-10 justify-center " +
                        ...
                        <button
                            className={
                                "h-6 px-1 py-0.5 text-white text-[9px] leading-5 tracking-[.21em] rounded-[2px] flex items-center w-10 justify-center " +

...
const Optional = (props) => {
    ...
    const handleDecoration = (val) => {
        switch (val) {
            case 1:
                setState({ ...state, decoration: val, bold: !bold });
                break;
            case 2:
                setState({ ...state, decoration: val, italic: !italic });
                tinymce.activeEditor.execCommand('Underline');
                break;
            case 3:
                setState({ ...state, decoration: val, underline: !underline });
                tinymce.activeEditor.execCommand('Strikethrough');
                break;
            case 4:
                setState({ ...state, decoration: val, strikethr: !strikethr });
                tinymce.activeEditor.execCommand('Strikethrough');
                break;
            default:
                break;
        ...
        <div>
            ...
            <div className=" flex flex-col items-start p-4 gap-3 border-b border-[#262626]">
                <div className="flex justify-between w-full">
                    ...
                    <div className="flex flex-row justify-between  items-center w-full ">
                        <div className="flex flex-row justify-between items-center bg-[#161616] border border-[#404040] w-44 h-8 p-1 rounded-md">
                            <button
                                className={
                                    "h-6 px-4 py-0.5 text-white text-[9px] leading-5 tracking-[.21em] rounded-[2px] flex items-center " +
                            ...
                            <button
                                className={
                                    "h-6 px-3 py-0.5 text-white text-[9px] leading-5 tracking-[.21em] rounded-[2px] flex items-center " +
                                    (state.italic === 2 ? "bg-[#5F5F5F]" : "bg-transparent")
                                }
                                onClick={() => {
                                    handleDecoration(2)
                                }}
                            ...
                            <button
                                className={
                                    "h-6 px-3 py-0.5 text-white text-[9px] leading-5 tracking-[.21em] rounded-[2px] flex items-center " +
                                    (state.underline === 3 ? "bg-[#5F5F5F]" : "bg-transparent")
                                }
                                onClick={() => {
                                    handleDecoration(3)
                                }}
                            ...
                            <button
                                className={
                                    "h-6 px-3 py-0.5 text-white text-[9px] leading-5 tracking-[.21em] rounded-[2px] flex items-center " +
                                    (state.strikethr === 3 ? "bg-[#5F5F5F]" : "bg-transparent")
                                }
                                onClick={() => {
                                    handleDecoration(4)
                                }}

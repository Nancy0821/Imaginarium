    ...
    const handleListChange = (val) => {
        ...
        switch (val) {
            ...
            case 3:
                ...
                break;
            case 4:
                tinymce.activeEditor.execCommand('InsertDefinitionList', false, { 'list-style-type': 'circle' });
                break;
            case 5:
                tinymce.activeEditor.execCommand('InsertDefinitionList', false, { 'list-style-type': 'square' });
                break;
            case 6:
                tinymce.activeEditor.execCommand('InsertDefinitionList', false, { 'list-style-type': 'upper-alpha' });
                break;
        }
    }

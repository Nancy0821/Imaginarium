...
const Optional = (props) => {
    ...
    const handleCaseChange = (val) => {
        switch (val) {
            case 1:
                setState({ ...state, pCase: 1, case1: !state.case1 });
                tinymce.activeEditor.execCommand("mceTitleCase");
                break;
            case 2:
                setState({ ...state, pCase: 2, case12: !state.case2 });
                tinymce.activeEditor.execCommand("mceUpperCase");
                break;
            case 3:
                setState({ ...state, case3: !state.case3 });
                ...
                <div className="flex flex-row justify-between  items-center w-full ">
                    ...
                    <div className="flex flex-row justify-between items-center bg-[#161616] border border-[#404040]  h-8 p-1 rounded-md">
                        <button
                            className={
                                "h-6 px-3 py-0.5 text-white text-[9px] leading-5 tracking-[.21em] rounded-[2px] flex items-center " +
                                (state.case1 ? "bg-[#5F5F5F]" : "bg-transparent")
                            }
                            onClick={() => {
                                handleCaseChange(1)
                            }}
                        ...
                        <button
                            className={
                                "h-6 px-3 py-0.5 text-white text-[9px] leading-5 tracking-[.21em] rounded-[2px] flex items-center " +
                                (state.case2 ? "bg-[#5F5F5F]" : "bg-transparent")
                            }
                            onClick={() => {
                                handleCaseChange(2)
                            }}
                        ...
                        <button
                            className={
                                "h-6 px-3 py-0.5 text-white text-[9px] leading-5 tracking-[.21em] rounded-[2px] flex items-center " +
                                (state.case3 ? "bg-[#5F5F5F]" : "bg-transparent")
                            }
                            onClick={() => {
                                handleCaseChange(3)
                            }}
